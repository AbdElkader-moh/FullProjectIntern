...
public class UserController {
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "Email already registered",
            content = @Content(schema = @Schema(implementation = ApiResponse.class)))
    public ResponseEntity<UserResponse> signup(@Valid @ModelAttribute SignupRequest request, HttpSession session) {
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Not authenticated")
    public ResponseEntity<List<SettingsDTO>> getSettings(HttpSession session) {
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Validation error — missing or invalid fields")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Not authenticated")
    public ResponseEntity<Object> updateSettings(@RequestBody SettingsDTO request, HttpSession session) {
        String validationError = userService.validateSettingsRequest(request);
        if (validationError != null) {
            return ResponseEntity.badRequest().body(new ApiResponse(validationError));
        }
    ...
    public ResponseEntity<ApiResponse> deleteSetting(
        ...
        return ResponseEntity.ok(new ApiResponse("Setting deleted successfully"));
    }
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Not authenticated")
    public ResponseEntity<ApiResponse> markAllNotificationsAsRead(HttpSession session) {
