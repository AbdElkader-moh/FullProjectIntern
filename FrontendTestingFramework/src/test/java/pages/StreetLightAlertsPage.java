 ...
 *   - Type badge always has class .type-light (no .type-air or .type-light).
 *
 *  Unchanged:
 ...
 */
public class StreetLightAlertsPage extends BasePage {
     ...
     * Options: "" (all), "Power Consumption", "Brightness Level"
     */
    ...
    public StreetLightAlertsPage(WebDriver driver) {
        super(driver);
    }

    // ── Navigation ────────────────────────────────────────────────────────────

    @Step("Open street light alerts page directly")
    public StreetLightAlertsPage open() {
...
// In StreetLightAlertsPage, replace enterDateFrom and enterDateTo with:
    ...
    public StreetLightAlertsPage enterDateTo(String dateTo) {
    ...
    public StreetLightAlertsPage clickApplyFilters() {
    ...
    public StreetLightAlertsPage clickResetFilters() {
    ...
    public StreetLightAlertsPage clickMarkAllRead() {
        wait.waitForClickable(MARK_ALL_BTN).click();
        return this;
    }

    @Step("Click Mark Read on first unread alert")
    public StreetLightAlertsPage clickMarkReadOnFirst() {
    ...
    public StreetLightAlertsPage clickDeleteFirst() {
    ...
    public StreetLightAlertsPage dismissFirstToast() {
    ...
    public boolean isOnAlertsPage()             { return urlContains("/lights-alerts"); }
