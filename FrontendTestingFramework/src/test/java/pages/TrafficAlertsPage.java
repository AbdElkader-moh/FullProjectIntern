 ...
 *     "Traffic Density" and "Average Speed" (from metricOptions array in TS).
 ...
 *   - Type badge always has class .type-traffic (no .type-air or .type-light).
 *
 *  Unchanged:
...
public class TrafficAlertsPage extends BasePage {
     ...
     * Options: "" (all), "Traffic Density", "Average Speed"
     */
    ...
    /**
     * Type badges are now always .type-traffic (page is traffic-only).
     */
    private static final By TYPE_BADGES        = By.cssSelector(".type-badge.type-traffic");
    ...
    public TrafficAlertsPage selectMetricFilter(String metric) {
...
// In TrafficAlertsPage, replace enterDateFrom and enterDateTo with:
    ...
    public TrafficAlertsPage dismissFirstToast() {
